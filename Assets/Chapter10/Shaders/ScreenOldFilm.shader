Shader "Vedmate/Chapter10/ScreenOldFilm"
{
    Properties
    {
        _MainTex ("Base (RGB)", 2D) = "white" {}
        _VignetteTex ("Vignette Texture", 2D) = "white" {}
        _ScratchesTex ("Scrathes Texture", 2D) = "white" {}
    ...
    SubShader
    {
        Pass
        {
            ...
            fixed4 frag (v2f_img i) : COLOR
            {
                ...
                half2 scratchesUV = half2( (i.uv.x + (_RandomValue * _SinTime.x * _ScratchesXSpeed)), (i.uv.y + (_Time.x * _ScratchesYSpeed)) );
