Shader "Vedmate/Chapter03/TextureBlending"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        {
            // Get the pixel data from the blend texture. We need a float 4 here because the texture will return R, G, B and A or X, Y, Z and W
